...
if __name__=="__main__":
    ...
    catalog_xyz = process_lightcone_catalog(lightcone="./lightcone_geometry/tng100_6_5_xyz.txt",
                                            base_dir='/home/tnguser/sims.TNG/TNG100-1/output/',mag_limit=magl)
    catalog_xyz = catalog_xyz.process_lightcone(minz=minz,maxz=maxz)
    catalog_xyz.output_catalog('./results/Lightcone_TNG100-1_mag30_6_5_xyz.txt')