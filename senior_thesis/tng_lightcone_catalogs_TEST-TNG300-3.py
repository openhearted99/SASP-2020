...
if __name__=="__main__":
    ...
    catalog_xyz = process_lightcone_catalog(lightcone="./tng300_6_5_xyz.txt",base_dir='/home/tnguser/sims.TNG/TNG300-3/output/',mag_limit=magl)
    catalog_xyz = catalog_xyz.process_lightcone(minz=minz,maxz=maxz)
    catalog_xyz.output_catalog('./Lightcone_TNG300-3_mag30_6_5_xyz_GFSTEST.txt')
